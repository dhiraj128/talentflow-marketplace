  ...
  return (
    <form onSubmit={handleSubmit} className="w-full max-w-[960px] mx-auto">
      <div className="relative flex flex-col md:flex-row md:items-stretch w-full gap-3 md:gap-0 md:h-[64px] md:bg-white md:rounded-2xl md:shadow-xl md:shadow-purple-950/10 md:border md:border-slate-200/80 md:overflow-hidden md:focus-within:ring-2 md:focus-within:ring-purple-500/40 transition-all">
        ...
        {/* Input Section */}
        <div className="relative flex-1 flex items-center bg-white rounded-xl md:rounded-none shadow-md md:shadow-none border border-slate-200/80 md:border-0 h-[52px] md:h-full overflow-hidden">
          ...
          <input
            ...
            className="h-full w-full pl-12 md:pl-14 pr-10 md:pr-12 border-0 bg-transparent text-slate-900 placeholder:text-slate-400 text-sm md:text-base font-normal outline-none focus:outline-none focus:ring-0 rounded-none shadow-none truncate"
          />
          {value && (
            <button
              type="button"
