...
- Name: find-jobs-visual-responsive.spec.ts >> Phase 14 — Automated Visual & Geometry Responsive Assertions on Find Jobs >> Find Jobs Page Layout & Input Geometry at 1440px
- Location: tests\find-jobs-visual-responsive.spec.ts:9:9

# Error details

```
Error: Input height at 1440px must be >= 40px
