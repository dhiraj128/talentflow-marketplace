...
- Name: live-public-signups.spec.ts >> Live Public Signup & Verification Removal Suite >> Public Signup for Role CANDIDATE (Job Seeker) Direct without Verification Method
- Location: tests\live-public-signups.spec.ts:16:9

# Error details

```
Error: Role CANDIDATE must navigate to role dashboard or sign-in cleanly without OTP prompt
        ...
        - generic [ref=e117]:
          ...
          - generic [ref=e122]:
            - generic [ref=e123]:
              ...
              - paragraph [ref=e125]: Create your Job Seeker account
            - generic [ref=e126]:
              - img [ref=e127]
