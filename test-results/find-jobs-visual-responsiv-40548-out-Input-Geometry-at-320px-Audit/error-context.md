...
- Name: find-jobs-visual-responsive.spec.ts >> Phase 14 — Automated Visual & Geometry Responsive Assertions on Find Jobs >> Find Jobs Page Layout & Input Geometry at 320px
