...
const models = ['Coupon', 'Offer'];
const lowerPlural = ['coupons', 'offers'];
const classPlural = ['Coupons', 'Offers'];
...
console.log('Successfully generated controllers, services, and modules.');
