...
export declare class OffersController {
    ...
    update(id: string, dto: UpdateOfferDto, req: any): Promise<{
        id: string;
        applicationId: string;
        employerId: string;
        candidateId: string;
    ...
    sendOffer(id: string, req: any): Promise<{
        id: string;
        applicationId: string;
        employerId: string;
        candidateId: string;
    ...
    acceptOffer(id: string, req: any): Promise<{
        id: string;
        applicationId: string;
        employerId: string;
        candidateId: string;
