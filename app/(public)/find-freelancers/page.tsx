  ...
  return (
    <div className="bg-slate-50 min-h-screen pb-20">
      ...
      <div className="bg-gradient-to-b from-purple-900 via-purple-800 to-indigo-900 text-white pt-10 pb-8 px-6 rounded-b-[2rem] shadow-xl relative overflow-hidden">
        ...
        <div className="max-w-[900px] mx-auto text-center space-y-2 relative z-10">
          ...
          <div className="pt-1 flex flex-wrap justify-center gap-2 text-xs md:text-sm text-purple-200">
